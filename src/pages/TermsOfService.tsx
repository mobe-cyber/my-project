...
const TermsOfService = () => {
  ...
  const content = {
    ar: {
      ...
      acceptanceOfTermsText: "من خلال الوصول إلى هذا الموقع أو استخدامه، فإنك توافق على الالتزام بهذه الشروط. إذا لم توافق، يرجى عدم استخدام الخدمة.",
      ourServices: "خدماتنا",
      serviceDigitalBooks: "بيع الكتب الرقمية",
      serviceReading: "إمكانية القراءة عبر الإنترنت",
      serviceLibrary: "إدارة مكتبة شخصية",
      serviceRecommendations: "توصيات شخصية بناءً على اهتماماتك",
      accountRegistration: "الحساب والتسجيل",
      accountRegistrationText: "للوصول إلى بعض الخدمات، قد تحتاج إلى إنشاء حساب.",
      accountRequirement1: "يجب أن تكون عمره 13 عامًا على الأقل",
      ...
      acceptableUseText: "يجب استخدام الخدمة وفقًا للقوانين المحلية.",
      ...
      intellectualPropertyText: "جميع المحتويات المتوفرة على الموقع محمية بموجب قوانين الملكية الفكرية.",
      ...
      changesOfTerms: "تغيير الشروط",
      changesOfTermsText: "قد نعدل هذه الشروط حسب الحاجة وسنعلن عن التغييرات.",
    ...
    en: {
      ...
      acceptanceOfTermsText: "By accessing or using this website, you agree to be bound by these terms. If you do not agree, please do not use the service.",
      ourServices: "Our Services",
      serviceDigitalBooks: "Sale of digital books",
      serviceReading: "Online reading capability",
      serviceLibrary: "Personal library management",
      serviceRecommendations: "Personalized recommendations based on your interests",
      ...
      acceptableUseText: "The service must be used in accordance with local laws.",
      ...
      intellectualPropertyText: "All content on the website is protected under intellectual property laws.",
      ...
      changesOfTerms: "Changes to Terms",
      changesOfTermsText: "We may modify these terms as needed and will announce changes.",
      ...
      <div className="container mx-auto py-10 flex-grow">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            {/* الخدمات */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">{content[language].ourServices}</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                <li>{content[language].serviceDigitalBooks}</li>
                <li>{content[language].serviceReading}</li>
                <li>{content[language].serviceLibrary}</li>
                <li>{content[language].serviceRecommendations}</li>
              </ul>
            </div>
            ...
            {/* الاستخدام المقبول */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">{content[language].acceptableUse}</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                {content[language].acceptableUseText}
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
